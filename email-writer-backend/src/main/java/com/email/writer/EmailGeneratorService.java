...
public class EmailGeneratorService {
    ...
    private String extractResponseContent(String response) {
        try {
            ...
            if (!candidatesNode.isMissingNode() && candidatesNode.size() > 0) {
    ...
    private String buildPrompt(EmailRequest emailRequest) {
        ...
        prompt.append("Generate a professional email reply for the following. Please don't generate a subject line.");
